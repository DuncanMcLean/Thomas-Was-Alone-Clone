...
SoundManager::SoundManager()
{
	...
	// New sound buffers
	m_LavaBuffer.loadFromFile("sound/lava.wav");
	m_StarBuffer.loadFromFile("sound/star.wav");
	m_BlackHoleBuffer.loadFromFile("sound/blackhole.wav");
	...
	// New sounds
	m_Lava.setBuffer(m_LavaBuffer);
	m_Star.setBuffer(m_StarBuffer);
	m_BlackHole.setBuffer(m_BlackHoleBuffer);
...
void SoundManager::playLava()
{
	m_Lava.setRelativeToListener(true);
	m_Lava.play();
}

void SoundManager::playStar()
{
	m_Star.setRelativeToListener(true);
	m_Star.play();
}

void SoundManager::playBlackHole()
{
	m_BlackHole.setRelativeToListener(true);
	m_BlackHole.play();
}